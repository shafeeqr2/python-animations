...
def main():
    ...
    e = box(pos=vector(10,10,-10), size=(5,5,5), color = (0,.35,0))
    f = box(pos=vector(-10,10,-10), size=(5,5,5), color = (.93, .46,0))
    g = box(pos=vector(-10,-10,-10), size=(5,5,5), color = (.93, .79, 0))
    h = box(pos=vector(10,-10,-10), size=(5,5,5), color = (0,.25,.53))
